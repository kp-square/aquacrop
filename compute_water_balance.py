...
def compute_balance_process( hourly, use_richards, use_irrigation):
    # no. of cores  = 54
...
def main():
    ...
    compute_balance_process(hourly, use_richards, use_irrigation)

if __name__=='__main__':
    # compute_balance_process(False, True)
    main()
