...
# We removed the variable ClockStruct_EvapTimeSteps since timestep is hourly now
# We use hourly values of et0, Infl, Rain and Irr instead of daily
def soil_evaporation_hourly(
