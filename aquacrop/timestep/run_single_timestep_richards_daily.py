...
from ..utils.richards.richards_eqn_solver import  RichardEquationSolverDaily
...
def solution_single_time_step_richards_daily(
    ...
    solver = RichardEquationSolverDaily(Soil.profile, PrevCond)

    NewCond, DeepPerc, Runoff, Infl, FluxOut = solver.solve(NewCond, Irr, Infl)
